...
JRobot::JRobot(LPCTSTR imgPath, int frameWidth, int frameHeight, int winWidth, int winHeight)
...
void JRobot::updatePostion(int xDir, int yDir, int jumpDir, T_Map* pBarrier)
{
...
void JRobot::jumpUpDown(T_Map* pBarrier)
{
	// 为速度加上重力影响
